...
=======
  <div>
    ...
    <div class="video">
      <video ref="localVideo" class="video-js" controls preload="auto" width="640" height="480"></video>
      <br />
      <video ref="remoteVideo" class="video-js" controls preload="auto" width="640" height="480"></video>
    </div>
    <div>
