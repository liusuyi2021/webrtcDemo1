...
(function(f){
  ...
  else{g=this}g.adapter = f()}})(function(){var define,module,exports;return (function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
/*
...
function shimGetStats(window) {
  ...
  window.RTCPeerConnection.prototype.getStats = function getStats() {
    ...
    var makeMapStats = function makeMapStats(stats) {
      return new cMap(Object.keys(stats).map(function (key) {
...
function shimSenderGetStats(window) {
  ...
  window.RTCRtpSender.prototype.getStats = function getStats() {
    return this.track ? this._pc.getStats(this.track) : Promise.resolve(new cMap());
  };
}
...
function wrapPeerConnectionEvent(window, eventNameToWrap, wrapper) {
  ...
  proto.addEventListener = function (nativeEventName, cb) {
    ...
    if (!this._eventMap[eventNameToWrap]) {
      this._eventMap[eventNameToWrap] = new cMap();
    }
    console.log("111111111111111111111111111111111111111"+_eventMap[eventNameToWrap])
